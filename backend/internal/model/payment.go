...
type Payment struct {
	...
	AbacateCheckoutID string             `bson:"abacateCheckoutId,omitempty" json:"abacateCheckoutId,omitempty"`
	AbacateCheckoutURL string            `bson:"abacateCheckoutUrl,omitempty" json:"abacateCheckoutUrl,omitempty"`
